...
newsDateData = list()
for obj in Data:
    newsDateData.append([obj['uuid'], obj['published'].split('T')[0], obj['title'], obj['text']])
...
train_size = 0.2 # split value for train and test
...
targetTrain = train_dataframe['Price_Change_cat'].values
targetTest = test_dataframe['Price_Change_cat'].values
...
# plt.show()
plt.savefig("E:\\Thesis\\Chats and Images\\RNN\\Cross-Entropy Loss"+timeStr+".png", format="png", dpi=fig1.dpi)
...
plt.legend(loc='upper left')
# plt.show()
plt.savefig("E:\\Thesis\\Chats and Images\\RNN\\Accuracy"+timeStr+".png", format="png", dpi=fig2.dpi)
